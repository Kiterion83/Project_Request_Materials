    ...
    <div>
      ...
      <div style={s.card}>
        ...
        <div style={s.dashGrid}>
          ...
          <div style={s.dashBox('#EA580C')}><div style={{ fontSize: 42, fontWeight: '800' }}>{stats.lost}</div><div style={{ fontSize: 14, marginTop: 8, opacity: 0.9 }}>🚫 Lost</div></div>
          <div style={s.dashBox(COLORS.purple)}><div style={{ fontSize: 42, fontWeight: '800' }}>{stats.broken}</div><div style={{ fontSize: 14, marginTop: 8, opacity: 0.9 }}>💔 Broken</div></div>
        </div>
      </div>
      <div style={s.card}>
